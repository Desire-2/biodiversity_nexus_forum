...
from app.forms import RegistrationForm, LoginForm, UpdateAccountForm, PostForm, CommentForm, ArticleForm, ForumForm, BlogForm, RequestResetForm, ResetPasswordForm
from app.models import User, Post, Comment, Article, Forum, Blog
...
def new_article():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('Your article has been uploaded!', 'success')
        return redirect(url_for('home'))
